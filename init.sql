...
INSERT INTO `permission`(`perm_id`, `perm_name`, `perm_interface`, `creat_time`, `update_time`) VALUES (1358608022330544128, 'cmdb模板生成', '/cmdb/create_cmdb_template', NOW(), NOW());
...
INSERT INTO `role_perm`(`id`, `role_id`, `perm_id`) VALUES (1358608061673115648, 1346283931393200128, 1358608022330544128);
